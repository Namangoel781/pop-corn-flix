...
import logo1 from "../../public/movielogo.png";
...
const Nav = () => {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        // variant="small"
        // color="blue-gray"
        className="flex items-center gap-x-2 p-1 font-medium hover:text-yellow-500"
      >
        <svg
          width="16"
          height="15"
      ...
      >
        ...
        <a href={"/tvshows"} className="flex items-center">
          Tv Shows
        </a>
      </Typography>
    </ul>
  ...
  return (
    // <div className="flex justify-between mdLpx-10 sm:px-5 px-5 items-center gap-3 text-xl my-3">
    //   <img
    //     src={logo1}
    //     alt=""
    //     className="md:h-14 sm:h-10 h-10 hover:opacity-80 cursor-pointer"
    //     onClick={() => navigate("/")}
    //   />
    ...
    //         type="text"
    //         placeholder="Search"
    //         className="border-gray-500 bg-zinc-900 text-white rounded-2xl md:w-fit sm:w-[30vw]"
    //         value={searchText}
    //         onChange={handleChange}
    //       />
    //     </form>
    //     <div className="md:block ">
    //       <div className="flex gap-6 items-center text-white lg:text-lg sm:text-sm">
    //         <div className="hover:text-yellow-500 cursor-pointer">
    //           <Genres />
    //         </div>
    //         <Link to={"/movies"}>
    //           <div className="hover:text-yellow-500">Movies</div>
    //         </Link>
    //         <Link to={"/tvshows"}>
    //           <div className="hover:text-yellow-500">TV Shows</div>
    //         </Link>
    //       </div>
    //     </div>
    //   </div>
    // </div>
    <div className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 text-white">
      <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
        <img
          src={logo1}
          alt=""
          className="md:h-14 sm:h-10 h-10 hover:opacity-80 cursor-pointer mt-3"
          onClick={() => navigate("/")}
        />
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          ...
          >
            <Input
              type="search"
              placeholder="Search"
              className=" !border-t-blue-gray-300 bg-zinc-900 pl-9 placeholder:text-blue-gray-300 focus:!border-blue-gray-300"
              value={searchText}
              onChange={handleChange}
            />
          ...
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            ...
            >
              <Input
                type="search"
                placeholder="Search"
                className=" !border-t-blue-gray-300 pl-9 bg-zinc-900 placeholder:text-blue-gray-300 focus:!border-blue-gray-300"
                value={searchText}
                onChange={handleChange}
              />
              <div className="!absolute left-3 top-[13px]">
